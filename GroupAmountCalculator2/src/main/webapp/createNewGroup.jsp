			...
			<div id="container_demo">
				...
				<div id="wrapper">
					<div id="creategroup" class="animate form">
						<h1>Create Group</h1>
						<p>
							<label for="groupName" class="uname" data-icon="u">Group
								Name<span class="required">*</span>
							</label> <input id="groupName" name="groupName" required="required"
								type="text" placeholder="Please enter Group Name" /></br> <span
								id="warningOnecreate" class="error" style="display: block;"></span>
						</p></br>
						<p>
							<label for="groupMembers" class="youpasswd" data-icon="p">Group
								Members<span class="required">*</span>
							</label>
							<textarea type="text" id="groupMembers" name="groupMembers"
								required="required" placeholder="member1,member2......"
								title="Please enter group name seperated with comma"></textarea>
							</br> <span id="warningtwocreate" class="error"></span>
						</p>
						<p align="center">
							<button onclick="createGroup()" class="buttonall">Create</button>
